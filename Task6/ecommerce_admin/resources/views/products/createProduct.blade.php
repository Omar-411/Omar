...
@section('mainContent')
    <div class="col-12">
        ...
        <form action="{{ route('dashboard.products.storeProduct') }}" enctype="multipart/form-data" method="post">
            @csrf
            <div class="card">
                        ...
                        <div class="col-4">
                            ...
                            <select name="status" id="Status" class="form-control">
                                ...
                                @foreach ($status as $key => $value)
                                    <option @selected(old('status') == $key) value="{{ $key }}">{{ $value }}
                                    </option>
                                @endforeach
                            </select>
                            @error('Status')
                    ...
                    <div class="form-row mt-1">
                        <div class="col-4">
                            <label for="image">
                                ...
                                <img src="{{ asset('assets/images/add1.png') }}" id="img" style="cursor: pointer;"
                ...
                <div class="card-footer text-muted">
                    <button class="btn btn-outline-success btn-sm rounded" name="redirect" value="index"> Create </button>
                    <button class="btn btn-outline-warning btn-sm rounded" name="redirect" value="return"> Create & Return
                        Back</button>
                </div>
            </div>
        </form>
